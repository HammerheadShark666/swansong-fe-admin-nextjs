...
import ArtistDetailsForm from "@/app/(secure)/artists/components/artistDetailsForm";
import { Artist } from "@/app/types/artist/artist";
import { SelectItem } from "@/app/types/selectItem";
import ArtistPhotoForm from "@/app/(secure)/artists/components/artistPhotoForm";
import ArtistMembers from "@/app/(secure)/artists/components/members/artistMembers";
import ArtistDescriptionForm from "@/app/(secure)/artists/components/artistDescriptionForm";
