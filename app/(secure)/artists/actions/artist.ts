...
import { API_ARTIST_ADD, API_ARTIST_UPDATE, API_ARTIST_UPDATE_DESCRIPTION, API_DELETE_ARTIST, API_GET_ARTIST, API_GET_RANDOM_ARTISTS, API_SEARCH_ARTISTS_BY_LETTER, API_SEARCH_ARTISTS_BY_TEXT } from "@/app/lib/urls";
...
export async function deleteArtist(id: number): Promise<AddEditActionResponse | ErrorResponse> {  
  return await apiCallAuthenticated<AddEditActionResponse>(formatString(API_DELETE_ARTIST, id), API_METHOD.DELETE, "");
}