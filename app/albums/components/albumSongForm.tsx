...
// export default function SongForm({albumSong, albumId, mode, setShowSpinner, setSelectedRow, setMode, addSongToAlbumSongList, updateSongInAlbumSongList, removeSongFromList}: IProps) {
...
//   useEffect(() => {      
//     setFocus("song.title");
//     if(mode == "edit" && albumSong != null && albumSong != undefined && !hasError)  
